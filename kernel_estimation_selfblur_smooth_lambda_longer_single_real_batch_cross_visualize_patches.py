...
if __name__ == '__main__':
    ...
    # SCENE_LIST = ['deadleaves_lightroom']
    HR_DICT = {
    ...
    for folder in SCENE_LIST:
        ...
        cv2.imwrite(rf'{root}/temp/HR.png', HR)
        cv2.imwrite(rf'{root}/temp/LR.png', LR)
        ...
        for i in range(H // size):
            for j in range(W // size):
                ...
                cv2.imwrite(rf'{root}/temp/HR_{i}_{j}.png', HR_patch)
                cv2.imwrite(rf'{root}/temp/LR_{i}_{j}.png', LR_patch)
