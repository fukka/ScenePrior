...
if __name__ == '__main__':
    ...
    dataset = DIV2KRAWPSFBatchPatchifyDataset(
        ...
        # root='/group-volume/Fengjia-Contents/data/kernelGAN_data/PatternRAWPSF',
        # root='/group-volume/Fengjia-Contents/data/kernelGAN_data/PatternRAWPSF',
        patch_size=(500, 500),
        # batch_size=20,
        batch_size=1,
    ...
    visualize = True
    visualize_root = r'/group-volume/Fengjia-Contents/data/kernelGAN_data/evaluation_results/PatternRAWPSF_gcenter_oursv9_patch500_batch1'
    if visualize:
    ...
    for img_idx, val_data_list in enumerate(dataset):
        ...
        if visualize:
            img_HR_path = val_data_list[0]['img_HR_path']
            if 'coord' in val_data_list[0]:
                filename = os.path.basename(img_HR_path)[:-len('.png')] + f'_{val_data_list[0]["coord"]["top"]}_{val_data_list[0]["coord"]["left"]}'
            else:
                filename = os.path.basename(img_HR_path)[:-len('.png')]
