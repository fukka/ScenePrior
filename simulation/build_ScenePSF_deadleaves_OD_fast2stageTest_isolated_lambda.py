...
if __name__ == '__main__':
    ...
    save_root = r'/user/f.zhang2/data/scene/deadleaves_01_clips_v2/test_patch_OD_fast2stageTest_isolated_32bit_noise0d001'
    ...
    for filepath in file_list:
        ...
        while not covered_all:
            ...
            cv2.imwrite(os.path.join(save_root, filename[:-len('.png')] + f'_{img_iteration}_input.png'), blur_noisy_image)
            cv2.imwrite(os.path.join(save_root, filename[:-len('.png')] + f'_{img_iteration}_input_noNoise.png'), blur_image)
            cv2.imwrite(os.path.join(save_root, filename[:-len('.png')] + f'_{img_iteration}_target.png'), sharp_image)
            cv2.imwrite(os.path.join(save_root, filename[:-len('.png')] + f'_{img_iteration}_kernel.png'), kernel_image)
