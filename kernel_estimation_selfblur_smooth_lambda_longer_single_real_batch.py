...
if __name__ == '__main__':
    ...
    # root = r'/user/f.zhang2/data/temp4'
    ...
    for num in IMG_RANGE:
        ...
        root = os.path.join('/user/f.zhang2/data', folder)

        HR_file = rf'{root}/HR_ours.png'
        ...
        kernel_pred_np_v_whole = np.zeros((H // size * 15, W // size * 15, 3), dtype=np.uint16)
