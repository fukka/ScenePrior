...
if __name__ == '__main__':
    ...
    LR_dir = r'/user/f.zhang2/data/scene/graphics_01_clips/test_patch_OD_fast2stage_32bit_noise0d01_2/input_noNoise'
    Kernel_dir = r'/user/f.zhang2/data/scene/graphics_01_clips/test_patch_OD_fast2stage_32bit_noise0d01_2/kernel_npy'
    save_kernel_dir = HR_dir.replace('Scene_test_OD', 'Scene_test_OD_kernel')
    replace_name = r'_SwinIR_S_Scene_graphics_01_clip00_scale0.25_Fast2StagePSF_multiLR_test_noise_100k.png'
    ...
    for HR_file in HR_files:
        ...
        HR_gt = torch.from_numpy(np.float32(cv2.imread(LR_file.replace('input_noNoise', 'target'))[:, :, ::-1]) / 255.0).permute(2, 0, 1).unsqueeze(0).cuda()
