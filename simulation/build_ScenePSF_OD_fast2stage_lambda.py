...
if __name__ == '__main__':
    ...
    # save_root = r'/group-volume/Fengjia-Contents/data/scene_data/building_shifted_crops/test_patch_OD_fast2stage_32bit'
    # ori_root = r'/group-volume/Fengjia-Contents/data/scene_data/building_shifted_crops2/test/target'
    # save_root = r'/group-volume/Fengjia-Contents/data/scene_data/building_shifted_crops2/test_patch_OD_fast2stage_32bit'
    # save_root = r'/group-volume/Fengjia-Contents/data/scene_data/building_shifted_crops2/test_patch_OD_fast2stage_32bit_noise0d01'
    # ori_root = r'/group-volume/Fengjia-Contents/data/scene_data/building_shifted_crops2/train/target'
    # save_root = r'/group-volume/Fengjia-Contents/data/scene_data/building_shifted_crops2/train_patch_OD_fast2stage_32bit'
    # save_root = r'/group-volume/Fengjia-Contents/data/scene_data/building_shifted_crops2/train_patch_OD_fast2stage_32bit_noise0d01'
    # ori_root = r'/user/f.zhang2/data/scene/building_crops2/train/target'
    # save_root = r'/user/f.zhang2/data/scene/building_crops2/train_patch_OD_fast2stage_32bit_noise0d01'
    # ori_root = r'/user/f.zhang2/data/scene/brick_shift_crops/test/target'
    # save_root = r'/user/f.zhang2/data/scene/brick_shift_crops/test_patch_OD_fast2stage_32bit_noise0d01'
    # ori_root = r'/user/f.zhang2/data/scene/brick_zoom_crops/test/target'
    # save_root = r'/user/f.zhang2/data/scene/brick_zoom_crops/test_patch_OD_fast2stage_32bit_noise0d01'
    ori_root = r'/user/f.zhang2/data/scene/graphics_01_clips/test/target'
    save_root = r'/user/f.zhang2/data/scene/graphics_01_clips/test_patch_OD_fast2stage_32bit_noise0d01_2'
    ...
    for filepath in file_list:
        ...
        blur_noisy_image = np.zeros((H, W, 3))
        ...
        for y in y_starts:
            ...
            for x in x_starts:
                ...
                blur_noisy_patch_save = np.uint8(blur_noisy_patch[0].permute((1, 2, 0)).numpy() * 255)[:, :, ::-1]
