...
if __name__ == '__main__':
    ...
    HR_dir = r'/user/f.zhang2/data/scene/deadleaves_01_clips_v1/test_patch_OD_fast2stageTest_isolated_sn2_32bit_noise0d001/target'
    ...
    for HR_idx in tqdm.tqdm(range(len(HR_files))):
        ...
        HR = torch.from_numpy(np.float32(cv2.imread(HR_file)[:, :, ::-1]) / (2 ** 8 -1)).permute((2, 0, 1)).unsqueeze(0).cuda()
