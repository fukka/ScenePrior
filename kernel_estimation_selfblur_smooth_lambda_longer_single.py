...
if __name__ == '__main__':
    ...
    # exp = 'SwinIR_Scene_deadleavesv1_01_clip00_scale0.20_noise0d001_Fast2StagePSF_multiLR_GAN_test_noise_100k'
    # HR_dir = rf'/user/f.zhang2/projects/CVPR2026_deblur/results/{exp}/visualization/Scene_test_OD_hard'
    ...
    # Not working
    # exp = 'SwinIR_Scene_graphicsv2_01_clip00_scale0.25_noise0d001_Fast2StagePSF_multiLR_GAN_test_noise_100k'
    # HR_dir = rf'/user/f.zhang2/projects/CVPR2026_deblur/results/{exp}/visualization/Scene_test_OD_hard'
    ...
    # exp = 'SwinIR_Scene_graphicsv2_01_gamma_clip00_scale0.25_noise0d001_Fast2StagePSF_multiLR_GAN_test_noise_100k'
    # HR_dir = rf'/user/f.zhang2/projects/CVPR2026_deblur/results/{exp}/visualization/Scene_test_OD_hard'
    # LR_dir = r'/user/f.zhang2/data/scene/graphics_01_clips_v2/test_patch_OD_fast2stage_gamma_hard_32bit_noise0d001/input_noNoise_npy'
    # Kernel_dir = r'/user/f.zhang2/data/scene/graphics_01_clips_v2/test_patch_OD_fast2stage_gamma_hard_32bit_noise0d001/kernel_npy'

    exp = 'SwinIR_Scene_graphicsv1_02_gamma_clip00_scale0.20_noise0d001_Fast2StagePSF_multiLR_GAN_test_noise_100k'
    HR_dir = rf'/user/f.zhang2/projects/CVPR2026_deblur/results/{exp}/visualization/Scene_test_OD'
    LR_dir = r'/user/f.zhang2/data/scene/graphics_02_clips_v1/test_patch_OD_fast2stage_gamma_32bit_noise0d001/input_noNoise_npy'
    Kernel_dir = r'/user/f.zhang2/data/scene/graphics_02_clips_v1/test_patch_OD_fast2stage_gamma_32bit_noise0d001/kernel_npy'
    ...
    for HR_idx in tqdm.tqdm(range(len(HR_files))):
        ...
        # if not filename in ['frame_000_12_12.npy', 'frame_000_780_780.npy']:
        # if not filename in ['frame_000_780_268.npy', 'frame_000_268_524.npy']:
        if not filename in ['frame_000_268_140.npy', 'frame_000_652_268.npy']:
            continue
