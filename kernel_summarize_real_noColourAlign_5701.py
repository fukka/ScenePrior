...
if __name__ == '__main__':
    ...
    OUTPUT = "/user/f.zhang2/data/canon_5701_noColourAlign_normalize.npy"

    IMG_RANGE = range(5701, 5702)  # IMG_5642 to IMG_5651 inclusive

    # Specify relative paths (from ROOT) of npy files to skip
    SKIP_LIST = [
        "IMG_5701_noColourAlign/kernel_ours_7_9.npy",
    ]
