...
if __name__ == '__main__':
    ...
    kernel_estimator.num_iter = 500
    save_kernel_v = True

    exp_list = [
        # r'SwinIR_Scene_deadleavesv2_01_clip00_scale0.40_noise0d001_Fast2StagePSF_multiLR_GAN_test_noise_100k',
        r'SwinIR_Scene_deadleavesv2_01_clip01_scale0.45_noise0d001_Fast2StagePSF_multiLR_GAN_test_noise_100k',
        r'SwinIR_Scene_deadleavesv2_01_clip02_scale0.50_noise0d001_Fast2StagePSF_multiLR_GAN_test_noise_100k',
        r'SwinIR_Scene_deadleavesv2_01_clip03_scale0.55_noise0d001_Fast2StagePSF_multiLR_GAN_test_noise_100k',
        r'SwinIR_Scene_deadleavesv2_01_clip04_scale0.60_noise0d001_Fast2StagePSF_multiLR_GAN_test_noise_100k',
        r'SwinIR_Scene_deadleavesv2_01_clip05_scale0.65_noise0d001_Fast2StagePSF_multiLR_GAN_test_noise_100k',
        r'SwinIR_Scene_deadleavesv2_01_clip06_scale0.70_noise0d001_Fast2StagePSF_multiLR_GAN_test_noise_100k',
        r'SwinIR_Scene_deadleavesv2_01_clip07_scale0.75_noise0d001_Fast2StagePSF_multiLR_GAN_test_noise_100k',
        r'SwinIR_Scene_deadleavesv2_01_clip08_scale0.80_noise0d001_Fast2StagePSF_multiLR_GAN_test_noise_100k',
        r'SwinIR_Scene_deadleavesv2_01_clip09_scale0.90_noise0d001_Fast2StagePSF_multiLR_GAN_test_noise_100k',
    ]
    for exp in exp_list:
        HR_dir = rf'/group-volume/Fengjia/projects/CVPR2026_deblur/results/{exp}/visualization/Scene_test_OD'
        LR_dir = r'/group-volume/Fengjia/data/scene/deadleaves_01_clips_v2/test_patch_OD_fast2stage_32bit_noise0d001/input_noNoise_npy'
        Kernel_dir = r'/group-volume/Fengjia/data/scene/deadleaves_01_clips_v2/test_patch_OD_fast2stage_32bit_noise0d001/kernel_npy'
        ...
        print(f'{exp} kernel psnr: {sum(kernel_psnr_list) / len(kernel_psnr_list):.3f}')

        HR_dir = rf'/group-volume/Fengjia/projects/CVPR2026_deblur/results/{exp}/visualization/Scene_test_OD_hard'
        LR_dir = r'/group-volume/Fengjia/data/scene/deadleaves_01_clips_v2/test_patch_OD_fast2stage_hard_32bit_noise0d001/input_noNoise_npy'
        Kernel_dir = r'/group-volume/Fengjia/data/scene/deadleaves_01_clips_v2/test_patch_OD_fast2stage_hard_32bit_noise0d001/kernel_npy'
        replace_name = rf'_{exp}.npy'
        save_kernel_dir = HR_dir + '_kernel'
        if not os.path.exists(save_kernel_dir):
            os.makedirs(save_kernel_dir)
        ...
        for HR_idx in tqdm.tqdm(range(len(HR_files))):
            ...
            np.save(os.path.join(save_kernel_dir, filename), kernel_pred_np)
            deblur_psnr = calculate_psnr(HR_gt[0].permute(1, 2, 0).detach().cpu().numpy(),
                                         HR[0].permute(1, 2, 0).detach().cpu().numpy())
            kernel_psnr = calculate_psnr(kernel_gt_np, kernel_pred_np)
            # print('Kernel PSNR:', kernel_psnr, 'Deblur PSNR:', deblur_psnr)
            kernel_psnr_list.append(kernel_psnr)
