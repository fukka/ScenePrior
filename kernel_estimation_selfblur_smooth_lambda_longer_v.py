...
if __name__ == '__main__':
    ...
    exp_list = [
        # 'SwinIR_Scene_deadleavesv1_01_clip00_scale0.20_noise0d001_Fast2StagePSF_test_fast2stageTest_isolated_sn2_2_noise_100k_v',
        # 'SwinIR_Scene_deadleavesv1_01_clip00_scale0.20_noise0d001_GAN_Fast2StagePSF_test_fast2stageTest_isolated_sn2_2_noise_100k_v',
        # 'SwinIR_Scene_deadleavesv1_01_clip00_scale0.20_noise0d001_multiLR_Fast2StagePSF_test_fast2stageTest_isolated_sn2_2_noise_100k_v',
        # 'SwinIR_Scene_deadleavesv1_01_clip00_scale0.20_noise0d001_multiLR_GAN_Fast2StagePSF_test_fast2stageTest_isolated_sn2_2_noise_100k_v',

        # 'SwinIR_Scene_deadleavesv1_01_clip00_scale0.20_noise0d001_Fast2StagePSF_test_fast2stageTest_isolated_noise_100k_v',
        # 'SwinIR_Scene_deadleavesv1_01_clip00_scale0.20_noise0d001_GAN_Fast2StagePSF_test_fast2stageTest_isolated_noise_100k_v',
        # 'SwinIR_Scene_deadleavesv1_01_clip00_scale0.20_noise0d001_multiLR_Fast2StagePSF_test_fast2stageTest_isolated_noise_100k_v',
        # 'SwinIR_Scene_deadleavesv1_01_clip00_scale0.20_noise0d001_multiLR_GAN_Fast2StagePSF_test_fast2stageTest_isolated_noise_100k_v',


        # Ablation
        # L1+VGG+GAN+CDC
        # 'SwinIR_Scene_deadleavesv1_01_clip00_scale0.20_noise0d001_Fast2StagePSF_multiLR_GAN_test_fast2stageTest_isolated_sn2_2_size128_noise_100k_v',
        # L1
        # 'SwinIR_Scene_deadleavesv1_01_clip00_scale0.20_noise0d001_Fast2StagePSF_sn2_2_size128_test_fast2stageTest_isolated_sn2_2_noise_30k_v',
        # L1+CDC
        # 'SwinIR_Scene_deadleavesv1_01_clip00_scale0.20_noise0d001_Fast2StagePSF_sn2_2_size128_multiLR_test_fast2stageTest_isolated_sn2_2_noise_50k_v',
        # L1+VGG+GAN
        # 'SwinIR_Scene_deadleavesv1_01_clip00_scale0.20_noise0d001_Fast2StagePSF_sn2_2_size128_GAN_test_fast2stageTest_isolated_sn2_2_noise_40k_v',
        # SwinIR-S
        # 'SwinIR_S_Scene_deadleavesv1_01_clip00_scale0.20_noise0d001_Fast2StagePSF_sn2_2_size128_multiLR_GAN_test_fast2stageTest_isolated_sn2_2_noise_40k_v',
        # DIV2K
        # 'SwinIR_Scene_DIV2K_noise0d001_Fast2StagePSF_sn2_2_size128_multiLR_GAN_test_fast2stageTest_isolated_sn2_2_noise_20k_v',
        # frame_1
        # 'SwinIR_Scene_deadleavesv1_01_clip00_scale0.20_noise0d001_Fast2StagePSF_sn2_2_size128_multiLR_GAN_frame1_test_fast2stageTest_isolated_sn2_2_noise_100k_v',
        # frame_2
        'SwinIR_Scene_deadleavesv1_01_clip00_scale0.20_noise0d001_Fast2StagePSF_sn2_2_size128_multiLR_GAN_frame2_test_fast2stageTest_isolated_sn2_2_noise_100k_v',
        # frame_3
        'SwinIR_Scene_deadleavesv1_01_clip00_scale0.20_noise0d001_Fast2StagePSF_sn2_2_size128_multiLR_GAN_frame3_test_fast2stageTest_isolated_sn2_2_noise_100k_v',
        # frame_4
        'SwinIR_Scene_deadleavesv1_01_clip00_scale0.20_noise0d001_Fast2StagePSF_sn2_2_size128_multiLR_GAN_frame4_test_fast2stageTest_isolated_sn2_2_noise_100k_v',
        # frame_5
        # 'SwinIR_Scene_deadleavesv1_01_clip00_scale0.20_noise0d001_Fast2StagePSF_sn2_2_size128_multiLR_GAN_frame5_test_fast2stageTest_isolated_sn2_2_noise_50k_v',
        # frame_6
        'SwinIR_Scene_deadleavesv1_01_clip00_scale0.20_noise0d001_Fast2StagePSF_sn2_2_size128_multiLR_GAN_frame6_test_fast2stageTest_isolated_sn2_2_noise_100k_v',
        # frame_7
        'SwinIR_Scene_deadleavesv1_01_clip00_scale0.20_noise0d001_Fast2StagePSF_sn2_2_size128_multiLR_GAN_frame7_test_fast2stageTest_isolated_sn2_2_noise_100k_v',
        # frame_8
        'SwinIR_Scene_deadleavesv1_01_clip00_scale0.20_noise0d001_Fast2StagePSF_sn2_2_size128_multiLR_GAN_frame8_test_fast2stageTest_isolated_sn2_2_noise_100k_v',
        # frame_9
        # 'SwinIR_Scene_deadleavesv1_01_clip00_scale0.20_noise0d001_Fast2StagePSF_sn2_2_size128_multiLR_GAN_frame9_test_fast2stageTest_isolated_sn2_2_noise_100k_v',
    ]

    for exp in exp_list:
        HR_dir = rf'/user/f.zhang2/projects/CVPR2026_deblur/results/{exp}/visualization/deadleaves_01_test_fast2stageTest_sn2'
        ...
        for HR_idx in tqdm.tqdm(range(len(HR_files))):
            ...
            if os.path.exists(os.path.join(save_kernel_dir, filename)):
                ...
                kernel_pred_np = np.load(os.path.join(save_kernel_dir, filename))
            else:
        ...
        HR_dir = rf'/user/f.zhang2/projects/CVPR2026_deblur/results/{exp}/visualization/deadleaves_01_test_fast2stageTest_hard_sn2'
        LR_dir = r'/user/f.zhang2/data/scene/deadleaves_01_clips_v1/test_patch_OD_fast2stageTest_hard_sn2_32bit_noise0d001/input_noNoise_npy'
        Kernel_dir = r'/user/f.zhang2/data/scene/deadleaves_01_clips_v1/test_patch_OD_fast2stageTest_hard_sn2_32bit_noise0d001/kernel_npy'
        replace_name = rf'_{exp}.npy'
        save_kernel_dir = HR_dir + '_kernel'
        if not os.path.exists(save_kernel_dir):
            os.makedirs(save_kernel_dir)
