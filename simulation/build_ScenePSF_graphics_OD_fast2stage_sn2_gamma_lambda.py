...
if __name__ == '__main__':
    ...
    save_root = r'/user/f.zhang2/data/scene/graphics_02_clips_v1/test_patch_OD_fast2stageTest_sn2_gamma_32bit_noise0d001'
    ...
    for filepath in file_list:
        ...
        senter_H_start = (H_sensor + 1) // 2
        senter_W_start = (W_sensor + 1) // 2
        y_idx = -1
        for y in y_starts:
            y_idx += 1
            x_idx = -1
