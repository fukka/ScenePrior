...
if __name__ == '__main__':
    ...
    # save_root = r'/user/f.zhang2/data/scene/brick_shift_crops/test_patch_OD_fast2stage_hard_32bit_noise0d01'
    # ori_root = r'/user/f.zhang2/data/scene/brick_zoom_crops/test/target'
    # save_root = r'/user/f.zhang2/data/scene/brick_zoom_crops/test_patch_OD_fast2stage_hard_32bit_noise0d01'
    ori_root = r'/user/f.zhang2/data/scene/graphics_01_clips/test/target'
    save_root = r'/user/f.zhang2/data/scene/graphics_01_clips/test_patch_OD_fast2stage_hard_32bit_noise0d01_2'
