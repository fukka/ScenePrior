...
if __name__ == '__main__':
    ...
    idx = 0
    pairs = []
    for HR_idx in range(0, len(HR_files), 200):
    ...
    # iter_list = range(20000, 100, -2000)
    # iter_list = range(100, 21000, 2000)
    iter_list = [100, 200, 400, 800, 2000, 4000, 6000, 8000, 10000, 15000, 20000]
