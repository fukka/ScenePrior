...
class net_kernel_RGB(nn.Module):
    ...
    def forward(self):
        ...
        return torch.cat((out_k_R, out_k_G, out_k_B), dim=1)
...
if __name__ == '__main__':
    ...
    # HR_dir = r'/group-volume/Fengjia-Contents/data/scene_data/building_shifted_crops/test_patch_OD_gtPSF_32bit/target'
    # # HR_dir = r'/group-volume/Fengjia-Contents/data/scene_data/building_shifted_crops/test_patch_OD_gtPSF_32bit/target_npy'
    # # LR_dir = r'/group-volume/Fengjia-Contents/project/fast_two_stage_psf_correction/results'
    # LR_dir = r'/group-volume/Fengjia-Contents/data/scene_data/building_shifted_crops/test_patch_OD_gtPSF_32bit/input'
    # # LR_dir = r'/group-volume/Fengjia-Contents/data/scene_data/building_shifted_crops/test_patch_OD_gtPSF_32bit/input_npy'
    # Kernel_dir = r'/group-volume/Fengjia-Contents/data/scene_data/building_shifted_crops/test_patch_OD_gtPSF_32bit/kernel_npy'

    # # HR_dir = r'/group-volume/Fengjia-Contents/data/scene_data/building_shifted_crops2/test_patch_OD_fast2stage_hard_32bit/target'
    # HR_dir = r'/group-volume/Fengjia-Contents/project/CVPR2026_deblur/results/SwinIR_nomask_ScenePSF2_Fast2StagePSF_test_40k/visualization/Scene_test_OD_hard'
    # LR_dir = r'/group-volume/Fengjia-Contents/data/scene_data/building_shifted_crops2/test_patch_OD_fast2stage_hard_32bit/input'
    # Kernel_dir = r'/group-volume/Fengjia-Contents/data/scene_data/building_shifted_crops2/test_patch_OD_fast2stage_hard_32bit/kernel_npy'

    # HR_dir = r'/group-volume/Fengjia-Contents/data/scene_data/building_shifted_crops2/test_patch_OD_fast2stage_hard_32bit/target'
    # HR_dir = r'/group-volume/Fengjia-Contents/project/CVPR2026_deblur/results/SwinIR_nomask_ScenePSF2_Fast2StagePSF_test_10k/visualization/Scene_test_OD'
    # LR_dir = r'/group-volume/Fengjia-Contents/data/scene_data/building_shifted_crops2/test_patch_OD_fast2stage_32bit/input'
    # Kernel_dir = r'/group-volume/Fengjia-Contents/data/scene_data/building_shifted_crops2/test_patch_OD_fast2stage_32bit/kernel_npy'

    # HR_dir = r'/group-volume/Fengjia-Contents/project/CVPR2026_deblur/results/SwinIR_nomask_ScenePSF2_Fast2StagePSF_test_10k/visualization/Scene_test_OD_hard'
    # LR_dir = r'/group-volume/Fengjia-Contents/data/scene_data/building_shifted_crops2/test_patch_OD_fast2stage_hard_32bit/input'
    # Kernel_dir = r'/group-volume/Fengjia-Contents/data/scene_data/building_shifted_crops2/test_patch_OD_fast2stage_hard_32bit/kernel_npy'

    # HR_dir = r'/group-volume/Fengjia-Contents/project/CVPR2026_deblur_codebookswinv2/results/SwinIR_S_Scene_Fast2StagePSF_multiLR_test_noise_100k/visualization/Scene_test_OD_hard'
    # LR_dir = r'/group-volume/Fengjia-Contents/data/scene_data/building_shifted_crops2/test_patch_OD_fast2stage_hard_32bit_noise0d01/input'
    # Kernel_dir = r'/group-volume/Fengjia-Contents/data/scene_data/building_shifted_crops2/test_patch_OD_fast2stage_hard_32bit_noise0d01/kernel_npy'
    # save_kernel_dir = HR_dir.replace('Scene_test_OD_hard', 'Scene_test_OD_hard_kernel')

    HR_dir = r'/group-volume/Fengjia-Contents/project/CVPR2026_deblur_codebookswinv2/results/SwinIR_S_Scene_Fast2StagePSF_multiLR_test_noise_100k2/visualization/Scene_test_OD_hard'
    LR_dir = r'/group-volume/Fengjia-Contents/data/scene_data/building_shifted_crops2/test_patch_OD_fast2stage_hard_32bit/input'
    Kernel_dir = r'/group-volume/Fengjia-Contents/data/scene_data/building_shifted_crops2/test_patch_OD_fast2stage_hard_32bit_noise0d01/kernel_npy'
    save_kernel_dir = HR_dir.replace('Scene_test_OD_hard', 'Scene_test_OD_hard_kernel')
    ...
    for HR_file in HR_files:
        # filename = os.path.basename(HR_file).replace('_SwinIR_nomask_ScenePSF2_Fast2StagePSF_test_10k', '')
        filename = os.path.basename(HR_file).replace('_SwinIR_S_Scene_Fast2StagePSF_multiLR_test_noise_100k2.npy', '.png')
        LR_file = os.path.join(LR_dir, filename)
        Kernel_file = os.path.join(Kernel_dir, filename[:-4] + '.npy')

        HR = torch.from_numpy(np.float32(np.load(HR_file))).permute(2, 0, 1).unsqueeze(0).cuda()
        # HR = torch.from_numpy(np.float32(cv2.imread(HR_file)[:, :, ::-1]) / 255.0).permute(2, 0, 1).unsqueeze(0).cuda()
        LR = torch.from_numpy(np.float32(cv2.imread(LR_file)[12:-12, 12:-12, ::-1]) / 255.0).permute(2, 0, 1).unsqueeze(0).cuda()
        ...
        if True:
            ...
            cv2.imwrite('/home/user/temp/kernel_gt_np.jpg', np.uint8(kernel_gt_np / np.max(kernel_gt_np) * 255))
            cv2.imwrite('/home/user/temp/kernel_pred_np.jpg', np.uint8(kernel_pred_np / np.max(kernel_pred_np) * 255))
