...
if __name__ == '__main__':
    # ori_root = r'/user/f.zhang2/data/scene/graphics_01_clips_v2/clip_00_scale_0.25_npy'
    # save_root = r'/user/f.zhang2/data/scene/graphics_01_clips_v2/clip_00_scale_0.25_npy_train_patch_ID_fast2stage_32bit_noise0d001'
    ori_root = r'/user/f.zhang2/data/scene/graphics_01_clips_v2/clip_01_scale_0.50_npy'
    save_root = r'/user/f.zhang2/data/scene/graphics_01_clips_v2/clip_01_scale_0.50_npy_train_patch_ID_fast2stage_32bit_noise0d001_'
    # ori_root = r'/user/f.zhang2/data/scene/graphics_01_clips_v2/clip_02_scale_1.00_npy'
    # save_root = r'/user/f.zhang2/data/scene/graphics_01_clips_v2/clip_02_scale_1.00_npy_train_patch_ID_fast2stage_32bit_noise0d001'
    # ori_root = r'/user/f.zhang2/data/scene/graphics_01_clips_v2/clip_03_scale_1.60_npy'
    # save_root = r'/user/f.zhang2/data/scene/graphics_01_clips_v2/clip_03_scale_1.60_npy_train_patch_ID_fast2stage_32bit_noise0d001'
    # ori_root = r'/user/f.zhang2/data/scene/graphics_01_clips_v2/clip_04_scale_2.40_npy'
    # save_root = r'/user/f.zhang2/data/scene/graphics_01_clips_v2/clip_04_scale_2.40_npy_train_patch_ID_fast2stage_32bit_noise0d001'
    # ori_root = r'/user/f.zhang2/data/scene/graphics_01_clips_v2/test/target'
    # save_root = r'/user/f.zhang2/data/scene/graphics_01_clips_v2/test_patch_ID_fast2stage_32bit_noise0d001'
    ...
    for filepath in file_list:
        ...
        for y in y_starts:
            ...
            for x in x_starts:
                ...
                sharp_patch_save = np.uint16(sharp_patch[0].permute((1, 2, 0)).numpy() ** (1 / 2.2) * 65535)[:, :, ::-1]
                blur_patch_save = np.uint16(blur_patch[0].permute((1, 2, 0)).numpy() ** (1 / 2.2) * 65535)[:, :, ::-1]
                blur_noisy_patch_save = np.uint16(blur_noisy_patch[0].permute((1, 2, 0)).numpy() ** (1 / 2.2) * 65535)[:, :, ::-1]
