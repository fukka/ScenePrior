...
if __name__ == '__main__':
    ...
    save_root = r'/user/f.zhang2/data/scene/deadleaves_01_clips_v1/test_patch_OD_fast2stageTest_isolated_sn_32bit_noise0d001'
    ...
    for filepath in file_list[:1]:
        ...
        while not covered_all:
            ...
            kernel = normalize_kernel(shift_kernel(kernel))
