...
if __name__ == '__main__':
    ...
    # save_root = r'/user/f.zhang2/data/scene/deadleaves_01_clips_v1/test_patch_OD_fast2stage_hard_32bit_noise0d001'
    ori_root = r'/user/f.zhang2/data/scene/deadleaves_01_clips_v2/test/target'
    save_root = r'/user/f.zhang2/data/scene/deadleaves_01_clips_v2/test_patch_OD_fast2stage_hard_32bit_noise0d001_'
