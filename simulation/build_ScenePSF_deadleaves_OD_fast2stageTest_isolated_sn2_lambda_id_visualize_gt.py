...
if __name__ == '__main__':
    ...
    for i in range(25):
        for j in range(40):
            kernel_path = os.path.join(r"/user/f.zhang2/data/scene/deadleaves_01_clips_v1/test_patch_OD_fast2stageTest_isolated_sn2_32bit_noise0d001/kernel_npy", map_dict[(i, j)])
