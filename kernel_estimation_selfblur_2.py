...
if __name__ == '__main__':
    ...
    HR_dir = r'/group-volume/Fengjia-Contents/project/CVPR2026_deblur_codebookswinv2/results/SwinIR_S_Scene_Fast2StagePSF_multiLR_test_noise_100k2/visualization/Scene_test_OD'
    LR_dir = r'/group-volume/Fengjia-Contents/data/scene_data/building_shifted_crops2/test_patch_OD_fast2stage_32bit/input'
    Kernel_dir = r'/group-volume/Fengjia-Contents/data/scene_data/building_shifted_crops2/test_patch_OD_fast2stage_32bit_noise0d01/kernel_npy'
